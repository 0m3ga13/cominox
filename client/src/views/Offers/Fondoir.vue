        ...
        <section class="max-w-4xl p-6 bg-gray-100 mx-auto rounded-md shadow-md mt-20">
            ...
            <div class="grid grid-cols-2">
                <div>
                    ...
                    <div class="block">
                        <div>
                            <input id="default-radio-1" v-model="formData.capacity" type="radio" value="400" name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="500L" class="p-4"> 400 L </label>
                        </div>
                        <div>
                            <input id="default-radio-1" type="radio" value="600" v-model="formData.capacity" name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="1000L" class="p-4"> 600 L</label>
                        </div>
                        <div>
                            <input id="default-radio-1" type="radio" v-model="formData.capacity" value="1500" name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="1000L" class="p-4"> 1500 L</label>
                        </div>
                        <div>
                            ...
                            <input id="capacites" type="number" v-model="formData.capacity"
                                class=" invisible peer-checked:visible px-4 w-20 text-gray-700 bg-white border border-gray-2     00 rounded-md      focus:border-blue-500     focus:outline-none focus:ring"
                                 >
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div>
                        <input id="default-radio-1" type="radio" value="" name="default-radio" v-model="formData.compartiments"
                            class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
    ...
    methods: {
        async submitForm() {
            try {
                ...
                const response = await API.addFondoir(this.formData);
