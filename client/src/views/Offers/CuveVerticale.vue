        ...
        <section class="max-w-4xl p-6 bg-gray-100 mx-auto rounded-md shadow-md mt-20">
            ...
            <div class="grid grid-cols-2">
                <div>
                    ...
                    <div class="block">
                        <div>
                            <input   id="default-radio-1" type="radio" value="3000" v-model="formData.capacity"
                                name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="500L" class="p-4"> 3000 L </label>
                        </div>
                        <div>
                            <input   id="default-radio-1" type="radio" v-model="formData.capacity" value="5000"
                                name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="1000L" class="p-4"> 5000 L</label>
                        </div>
                        <div>
                            <input   id="default-radio-1" type="radio" v-model="formData.capacity" value="10 000"
                                name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="1000L" class="p-4"> 10 000 L</label>
                        </div>
                        <div>
                            ...
                            <input id="capacites" type="number" v-model="formData.capacity"
                                class=" invisible peer-checked:visible px-4  text-gray-700 bg-white border border-gray-2     00 rounded-md      focus:border-blue-500     focus:outline-none focus:ring"
                                 >
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="phone" type="tel" v-model="formData.Phone" name="phone" placeholder="123-45-678"  
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md      focus:border-blue-500     focus:outline-none focus:ring"
                          >
                </div>
            </div>
    ...
    methods: {
        async submitForm() {
            try {
                ...
                const response = await API.addCuveVerticale(this.formData);
