    ...
    <form @submit.prevent="submitForm">
        <section class="max-w-4xl p-6 bg-gray-100 mx-auto rounded-md shadow-md mt-20">
            ...
            <div class="grid grid-cols-2">
                <div>
                    ...
                    <div class="block">
                        ...
                        <div>
                            <input id="default-radio-1" type="radio" value="5000" v-model="formData.capacity"
                                name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="1000L" class="p-4"> 5000 L</label>
                        </div>
                        <div>
                            <input id="default-radio-1" type="radio" value="10 000" v-model="formData.capacity"
                                name="default-radio"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    <label class="text-gray-900  " for="name">Client:</label>
                    <input id="name" type="text" v-model="formData.client"
    ...
    methods: {
        async submitForm() {
            try {
                ...
                const response = await API.addCuveHorizentale(this.formData);
