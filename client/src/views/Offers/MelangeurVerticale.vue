        ...
        <section class="max-w-4xl p-6 bg-gray-100 mx-auto rounded-md shadow-md mt-20">
            ...
            <div class="grid grid-cols-2">
                <div>
                    ...
                    <div class="block">
                        <div>
                            <input id="default-radio-1" type="radio" value="150" name="default-radio"
                                v-model="formData.capacity"
                                class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-teal-500 ">
                            <label for="500L" class="p-4"> 150 L </label>
                        </div>
                        <div>
    ...
    methods: {
        async submitForm() {
            try {
                ...
                const response = await API.addMelangeurVerticale(this.formData);
